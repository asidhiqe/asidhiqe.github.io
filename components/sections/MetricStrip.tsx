 ...
 * Upgraded from simple numbers to visual SVG diagnostics, demonstrating
 * systems-level data modeling directly to the recruiter.
 */
    ...
    >
      <div className="mx-auto grid grid-cols-1 gap-8 px-6 sm:grid-cols-3 sm:gap-0">
        ...
        <div className="flex flex-col items-start sm:items-center sm:text-center">
          ...
          <div className="mt-4 h-6 w-24 overflow-visible text-cyan-500/30">
        ...
        <div className="flex flex-col items-start border-zinc-900 sm:items-center sm:border-x sm:text-center">
          ...
          <div className="mt-4 flex gap-1.5" aria-hidden="true">
            {[...Array(7)].map((_, i) => (
              <span
                key={i}
                className="h-2 w-2 rounded-[1px] bg-neutral-800 border border-neutral-700/60"
        ...
        <div className="flex flex-col items-start sm:items-center sm:text-center">
          ...
          <div className="mt-4 h-6 w-24 overflow-visible text-neutral-700">
            <svg viewBox="0 0 100 24" className="w-full h-full">
