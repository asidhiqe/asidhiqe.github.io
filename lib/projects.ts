...
const FEATURED_PROJECTS: FeaturedProject[] = [
  {
    ...
    domains: ["AI & Observability", "Enterprise SaaS"],
    challenge:
    ...
    role: "Lead Product Designer at GlobalLogic (Boomi)",
    year: "2023 - Present",
    outcome:
  ...
  {
    id: "doctor-workbench",
    domains: ["Healthcare", "Clinical ERP"],
    challenge:
    ...
    role: "Founding Product Lead at Algaeh Technologies",
    year: "2018 - 2021",
    outcome:
  ...
  },
  {
    ...
    domains: ["BI Analytics", "Airport Operations"],
    challenge:
    ...
    role: "Lead UX/UI Designer at GrayMatter Software Services",
    year: "2015 - 2018",
    outcome:
